...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen">
      <div className="absolute inset-0 bg-[radial gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16_px] opacity-30 pointers-event-none" />
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
          {stats.map((stat, index) => (
            <div key={index} className="group relative bg-white/80 backdrop-blue-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1">
          ...
          {dashboardData.recentActivity &&
            ...
            <div className="sapce-y-3">
              {[
                ...
                .map((activity, index) => (
                  <div key={activity.id || index} className="group flex items-center justify-between p-4 rounded-xl bd-slate-50/50 border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
