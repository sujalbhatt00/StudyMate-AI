          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                required
                className="w-full h-9 pl-9 pr-3 border border-neutral-300 rounded-lg bg-white text-sm text-neutral-900 placeholder-neutral-400 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent"
                />
              </div>
            </div>
