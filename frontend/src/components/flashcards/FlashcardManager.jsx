...
const FlashcardManager = ({ documentId }) => {
    ...
    const handleConfirmDelete = async () => {
        ...
        console.log("Deleting:", setToDelete);
        setDeleting(true);
        try {
            await flashcardService.deleteFlashcardSet(setToDelete._id);
            toast.success("Flashcard set delete successfully");
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    <div className="flex items-center gap-6">
                        <button
                            ...
                            className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium rounded-xl transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
                        >
                            <ChevronLeft
                    ...
                    {flashcardSets.map((set) => (
                        <div
                            ...
                            <button
                                ...
                                className="absolute top-4 right-4 p-2 text-slate-400 hover:bg-rose-50 rounded-lg transition-all duration-200 opacity-0 group-hover:opacity-100"
                            >
